...
namespace WebApplication1.Controllers
{
    public class PointOfInterestsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Location,Description")] PointOfInterest pointOfInterest)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id,[Bind("Location,Description")] PointOfInterest pointOfInterest)
        {
